...
async function subirFirma(actaId, tipo, dataUrlBase64) {
  // Se acepta "image/svg+xml" además de los bitmaps (image/png, image/jpeg):
  // la firma dibujada a mano ahora se guarda como vector (Fase 1.2), y el
  // "+" del mimetype SVG no lo cubre \w+ solo.
